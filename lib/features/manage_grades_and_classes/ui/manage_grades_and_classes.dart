...
class _ManageGradesAndClassesState extends State<ManageGradesAndClasses> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<GradesCubit, GradesState>(
        ...
        builder: (context, state) {
          return state.when(
            initial: () =>
                const Center(child: Text('Press button to load grades.')),
            loading: () =>
                const GradesShimmerLoading(), // استخدم الـ widget الجديد هنا
            success: (data) {
              if (data is GradesResponse && (data.data?.isNotEmpty ?? false)) {
                return ListView(
                                ...
                                children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          AwesomeDialog(
                                            ...
                                            title: 'Delete Grade',
                                            desc:
                                                'Are you sure you want to delete "${grade.name}"? This action cannot be undone.', // Access name using dot notation
                                            btnOkText: 'Delete',
                                            btnCancelText: 'Cancel',
                                            btnOkOnPress: () {
                                              setState(() {
                                              ...
                                              AwesomeDialog(
                                                ...
                                                title: 'Deleted!',
                                                desc:
                                                    '"${grade.name}" has been successfully removed.', // Access name using dot notation
                                                btnOkOnPress: () {},
                                              ).show();
                                            },
                                          ).show();
                                  ...
                                  if (sections.isNotEmpty)
                                    for (
                                      ...
                                      Dismissible(
                                        key: ValueKey(
                                          '${grade.id}_${sections[sectionIndex].id ?? sectionIndex}',
                                        ),
                                        ...
                                        confirmDismiss: (direction) async {
                                          if (direction ==
                                            ...
                                            AwesomeDialog(
                                              ...
                                              desc:
                                                  'Are you sure you want to delete "${sections[sectionIndex].name}"? This cannot be undone.', // Access name using dot notation
                                              btnOkText: 'Delete',
                                              btnCancelText: 'Cancel',
                                              btnOkOnPress: () {
                                                setState(() {
                                                ...
                                                AwesomeDialog(
                                                  ...
                                                  title: 'Deleted!',
                                                  desc:
                                                      '"${sections[sectionIndex].name}" has been removed.', // Access name using dot notation
                                                  btnOkOnPress: () {},
                                                ).show();
                                              },
                                            ).show();
                                            ...
                                            AwesomeDialog(
                                              ...
                                              body: Padding(
                                                ...
                                                child: TextField(
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        'New name for "${sections[sectionIndex].name}"', // Access name using dot notation
                                                    border:
                                                        const OutlineInputBorder(),
                                                    filled: true,
                                                    fillColor: Colors.grey[100],
                                              ...
                                              btnOkOnPress: () {
                                                ...
                                                setState(() {
                                                  sections[sectionIndex].name =
                                                      newSectionName; // Update name using dot notation
                                                });
                                                _textController.clear();
                                              },
                                              btnCancelOnPress: () =>
            ...
            error: (error) =>
                Center(child: Text('Failed to load grades: $error')),
          );
        },
      ),
    );
